...
{
    private Piece piece; // piece that will do the move
    private Location source; // location of piece will do the move
    private Location destination; // destination of piece
    private boolean isEat; // if move include eating
    private Location enemyLoc; // location of piece will be eat
    private int grade; // grade for move (minimax)
    private int depth; //depth of move in minimax
