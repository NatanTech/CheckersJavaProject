...
public class Server
{
    ...
    /**
     * מכניסה את שני השחקנים שהתקבלו למשחק חדש ומתחילה את הרצת המשחק
     *
     * @param player1
     * @param player2 The function enter player1 and player2 to new game and run
     * the game
     */
    ...
    /**
     * מחזיר שחקן חדש שהתחבר לשרת בהצלחה
     *
     * @param clientSocket
        ...
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                while(true)
                {
                    ...
                    if(subject.equals(Constants.CANCEL_EXIT) || subject.equals(Constants.DELETE_USER))
                    {
    ...
    // search the game that specific player here
