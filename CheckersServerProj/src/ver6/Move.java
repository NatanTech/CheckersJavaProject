...
public class Move implements Serializable
{
    ...
    /**
     * Constructor to create new move
     *
     * @param piece piece that make the move
     * @param source source of piece
     * @param dest destination of piece
     * @param isEat if move include eat
     * @param enemyLoc location of opponent's piece has eaten (if exists)
     * @param burnedLoc location of burned piece (if exists)
     */
     ...
     *
     * @return true if this move in bounds of board, false otherwise
     */
