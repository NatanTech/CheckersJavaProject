...
import ver9.Piece.PieceColor;
import static ver9.Piece.PieceColor.*;
...
public class Game
{
            ...
            public void run()
            {
                ...
                while(true)
                {
                    ...
                    if(gameStopped)
                    {
                        ...
                        {
                            //System.out.println("save game player disconnected...");
    ...
    private void saveGamePlayerDisconnected()
    {
        ...
        System.out.println("player1: " + p1.getId() + ", p2: " + p2.getId());

        if(p1.getId().endsWith("disconnected"))
        {
            String un = p1.getId();
            String unP1 = un.substring(0, un.indexOf(' '));
            DB.gameOver(unP1, p2.getId(), p2.getId());
        }
