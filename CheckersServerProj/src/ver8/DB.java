...
public class DB
{
    ...
    public static Connection getConnection(String... dbFileRelativePath) throws SQLException
    {
        ...
        // the second and third parameters is user and pw to db
    ...
    public static ResultSet runQuery(String sql, String... dbFilePath) throws SQLException
    {
        ...
        // creates statement by the connection
        // parameter 1: the meaning is that the resultSet is scrollable but generally not sensitive to changes to the data that underlies the ResultSet
        // parameter 2: the meaning is that the resultSet is read only (not updateable)
    ...
    // =======================================================================
    /**
     * Checks if user with un and pw is exists in Users table
     *
     * @param un user name of user
     * @param pw password of user
     * @return true if user exists, false otherwise
     * @throws SQLException if the func can't run the query
     */
    ...
    /**
     * Gets all players un and pw from DB
     *
     * @return ArrayList of all players un and pw
     */
    public static ArrayList<GameInfo> getAllPlayers()
    {
        String sql = "SELECT un, pw FROM Users";
        try
        {
            ResultSet rs = runQuery(sql);
            ArrayList<GameInfo> allPlayers = new ArrayList<>();
            while(rs.next())
            {
                String un = rs.getNString("un"), pw = rs.getNString("pw");
                allPlayers.add(new GameInfo(un, pw));
            }
            return allPlayers;
        }
     ...
     *
     * @param ID of player that saved the game
     * @param board that the func need to save
     * @param playerTurn player that start play when game will continue
     */
    public static void saveBoardToDB(String ID, String board, String playerTurn)
    {
        ...
        {
            System.out.println("can't run query! please try again...");
        }
     ...
     *
     * @param p1 player 1 in game
     * @param p2 player 2 in game
     * @param pWinner the winner in the game
     */
    public static void gameOver(String p1, String p2, String pWinner)
    {
        ...
        {
            System.out.println("can't save game status! please try again...");
        }
    }
    ...
    /**
     * returns the top5 of game
     *
     * @return ArrayList of GameInfo of top 5 players
     * @throws SQLException
     */
    ...
    public static String getBoard(String un, String dateTime)
    {
        ...
        {
            System.out.println("couldn't run query...");
            return null;
        }
    }
    ...
    public static void main(String arg[]) throws SQLException
    {
        ...
        String board = "---b-----------------w------W---------------w-------------------";
        saveBoardToDB("a", board, "a");
...
//        JOptionPane optionPane = new JOptionPane("Hello everyone", -1, JOptionPane.DEFAULT_OPTION, null);
//
