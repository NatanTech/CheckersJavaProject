...
import static ver2_Game.Piece.PieceColor.BLACK_PLAYER;
import static ver2_Game.Piece.PieceColor.WHITE_PLAYER;
            ...
            public void run()
            {
                ...
                while(true)
                {
                    ...
                    while(!isGameOver)
                    {
                        ...
                        currentPlayerTurn.yourTurn(model);
                        Move move = currentPlayerTurn.getMove(model);
