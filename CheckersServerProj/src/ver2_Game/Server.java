        ...
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                while(true)
                {
                    ...
                    {
                        log("User " + player.getId() + " disconnected!");
...
//        }
    ...
    private void sendYourOpponentExit(Player player)
    {
        ...
        for(Game game : games)
        {
            ...
            boolean hasRegister = game.registerPlayerPlayed();
            ...
            if(un1.equals(unPlayer))
            {
                ...
                if(hasRegister)
                {
                    DB.gameOver(player1.getId(), player2.getId(), player2.getId());
                }
            ...
            if(un2.equals(unPlayer))
            {
                ...
                if(hasRegister)
                {
                    DB.gameOver(player1.getId(), player2.getId(), player1.getId());
                }
